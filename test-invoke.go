...
//Example code source: https://github.com/lmammino/invok
//Blog post source: https://buddy.works/tutorials/integration-testing-for-aws-lambda-in-go-with-docker-compose
//Usage: echo "{\"main\":\"hello\"}" | go run test-invoke.go
...
var host = flag.String("host", "localhost:8080", "The host where the lambda is running")
